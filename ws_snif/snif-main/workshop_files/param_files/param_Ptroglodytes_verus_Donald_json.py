...
#for c in [5, 6, 7]:
    ...
    #for w in [0.5, 1]:
        h_inference_parameters = InferenceParameters(
	        data_source = './workshop_files/input_data/Pan_troglodytes_verus_Donald_inferred-model-004.json', #path to the input file
	        source_type = SourceType.JSON, #type of input (SourceType.PSMC, SourceType.MS or SourceType.JSON)
...
# 	        bounds_event_times = [(2e4/gtime, 1e5/gtime), (1e5/gtime, 3e5/gtime), (3e5/gtime, 6e5/gtime), (7e5/gtime, 1e6/gtime), (2e6/gtime, 5e6/gtime)],
        ...
        h_settings = Settings(
	        ...
	        custom_filename_tag = 'Ptverus_Donald_fromjson', #custom tag added to the output name
